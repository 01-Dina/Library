                                ...
                                <div class="col-md-6">
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="tangal" value="<?php echo $tampil['tgl_input']; ?>" />
                                        </div>
...
<?php 
	...
	if ($simpan) {
		...
		$sql = $koneksi->query("Update buku set judul='$judul', pengarang='$pengarang', penerbit='$penerbit', tahun_terbit='$tahun', isbn='$isbn', jumlah_buku='$jumlah', lokasi='$lokasi', tgl_input='$tangal' where id=$id");
		if ($sql) {
			?>
